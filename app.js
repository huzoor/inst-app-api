...
app.use(function (req, res, next) {
    ...
    'Origin,instituteusername,instancename,schoolusername,staffusername,username,entitytype,appliedby,classid,subjectid,classenrolled,classcode,examtype,subjectcode,createdon,messageto,timelinemode,role,listmode,stuid,X-Requested-With,Content-Type,Accept,Authorization,x-access-token');
